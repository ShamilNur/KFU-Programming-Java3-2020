...
public class NewsQueries {
    ...
    // language=SQL
    public static final String SQL_SELECT_BY_ID = "SELECT * FROM news_hotel WHERE id = ?;";
    ...
    // language=SQL
    public static final String SQL_INSERT = "INSERT INTO news_hotel (title, description, photo) VALUES (?, ?, ?);";

    // language=SQL
    public static final String SQL_UPDATE_BY_ID = "UPDATE news_hotel SET title = ?, description = ?, photo = ? WHERE id = ?;";

    // language=SQL
    public static final String SQL_DELETE_BY_ID = "DELETE FROM news_hotel WHERE id = ?;";
}
